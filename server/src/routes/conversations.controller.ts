/**
 * controllers/conversations.controller.ts — FIXED: masquer = quitter la conv
 */
...
export const conversationsController = {
  ...
  /** DELETE /api/conversations/:id — Quitter/masquer une conversation */
  async hide(req: Request, res: Response): Promise<void> {
    try {
      ...
      // Supprimer la participation — la conv disparaît de la liste
